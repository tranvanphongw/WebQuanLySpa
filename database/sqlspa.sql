...
//này thêm ảnh do dịch vụ thiếu mục ảnh
ALTER TABLE DICHVU 
ADD COLUMN HINHANH VARCHAR(255) NOT NULL AFTER GIATIEN;

UPDATE DICHVU
SET HINHANH = 'massage_thai_co_truyen.jpg'
WHERE MADV = 1;

UPDATE DICHVU
SET HINHANH = 'massage_da_nong.jpg'
WHERE MADV = 2;

UPDATE DICHVU
SET HINHANH = 'cham_soc_da_mat.jpg'
WHERE MADV = 3;
