    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form id="bookingForm">
                    ...
                    <div class="form-group phone-group">
                        <div class="country-code">
                            <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/vn.svg"
                                alt="Vietnam" class="flag" />
                            <span>+84</span>
                            <i class="fa fa-chevron-down"></i>
                        </div>
                        <input type="tel" name="mobile" placeholder="Số điện thoại" id="mobile" class="form-control"
                            min="0" required />
                    </div>
                ...
                <div class="form-group">
                    <div class="form-title" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span id="current-date-display"
                            style="font-weight: normal; font-size: 14px; color: #555;"></span>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-title">Chọn khung giờ phục vụ <span style="color: var(--error-color);">*</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" class="form-control" rows="4"
                        placeholder="Thêm yêu cầu đặc biệt hoặc ghi chú khác..."></textarea>
                </div>
